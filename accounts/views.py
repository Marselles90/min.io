...
from .serializer import (
    ...
    CompanyProjectSerialzier, ComapnyProjectsCreateSerializer, CompanyProjectsUpdateSerialzier,
    ComapanySettingsSerialiser, CompanySettingsCreateSerializer, CompanySettingsUpdareSerialzier,
    CompanyAnaliticsMailSerialzier, CompanyAnaliticsMailCreateSerialzier, CompanyAnaliticsMailUpdateSerialzier
)
...
class CompanyProjectViewSet(BaseCRUD):
    permission_classes = [AllowAny]
    serializer_class = CompanyProjectSerialzier
    pagination_class = CustomPagination
    
    _model = CompanyProjects
    _serializer = serializer_class
    _serializer_create = ComapnyProjectsCreateSerializer
    _serializer_update = CompanyProjectsUpdateSerialzier


class CompanyProjectsSettingsViewSet(BaseCRUD):
    permission_classes = [AllowAny]
    serializer_class = ComapanySettingsSerialiser
    pagination_class = CustomPagination
    
    _model = CompanySettings
    _serializer = serializer_class
    _serializer_create = CompanySettingsCreateSerializer
    _serializer_update = CompanySettingsUpdareSerialzier


class CompanyAnaliticsViewSet(BaseCRUD):
    permission_classes = [AllowAny]
    serializer_class = CompanyAnaliticsMailSerialzier
    pagination_class = CustomPagination
    
    _model = CompanyAnaliticsMail
    _serializer = serializer_class
    _serializer_create = CompanyAnaliticsMailCreateSerialzier
    _serializer_update = CompanyAnaliticsMailUpdateSerialzier